...
class Sankhalainfo_Event_Adminhtml_EventController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->loadLayout();
			$this->_setActiveMenu('event/items');
    ...
    {
        $fileName   = 'event.csv';
        $content    = $this->getLayout()->createBlock('event/adminhtml_event_grid')
            ->getCsv();
